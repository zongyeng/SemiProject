...
CREATE TABLE MUSICIANSONG(
	...
	MUSICIANSONG_TITLE VARCHAR2(30) NOT NULL,
	...
	MUSICIANSONG_ALBUM VARCHAR2(20) DEFAULT '싱글',
	CONSTRAINT MUSICIANFK FOREIGN KEY(MUSICIANSONG_MUSICIANSEQ) REFERENCES USERINFO(USERINFO_SEQ)
);

SELECT MUSICIANSONG_SEQ, MUSICIANSONG_MUSICIANSEQ, MUSICIANSONG_NO, MUSICIANSONG_NAME, MUSICIANSONG_SIZE, MUSICIANSONG_TIME, MUSICIANSONG_HIGHLIGHTTIME, MUSICIANSONG_CONTENT, MUSICIANSONG_COMPOSER, MUSICIANSONG_LYRICIST, MUSICIANSONG_INPUTDATE, MUSICIANSONG_TAG, MUSICIANSONG_ENABLE, MUSICIANSONG_ALBUM FROM MUSICIANSONG;

INSERT INTO MUSICIANSONG 
	VALUES(SONGSEQ.NEXTVAL,'1','1','1_FUNKEYMUSIC','13','0350','0123','펑키뮤직!','박훈성','조영찬',SYSDATE,'funky','Y','싱글');
...
SELECT TIMELINE_SEQ, TIMELINE_MUSICIANSEQ, TIMELINE_NO, TIMELINE_TTITLE, TIMELINE_CONTENT, TIMELINE_REGDATE FROM TIMELINE WHERE TIMELINE_MUSICIANSEQ='1' ORDER BY TIMELINE_NO DESC;
...
CREATE TABLE FAVORITEMUSIC(
	...
	CONSTRAINT FAVORITEMUSICFK FOREIGN KEY(FAVORITEMUSIC_MUSICIANSEQ) REFERENCES USERINFO(USERINFO_SEQ)
);
...
CREATE TABLE MYMUSICLIST(
	...
	CONSTRAINT MYMUSICLIST FOREIGN KEY(MYMUSICLIST_MUSICIANSEQ) REFERENCES USERINFO(USERINFO_SEQ)
);
...
--앨범 고유번호, 뮤지션 고유번호, 앨범순서, 앨범 내용, 앨범 곡 수, 앨범 총 런타임, 앨범 설명, 앨범 추가 일자, 앨범 태그, 앨범 활성화 여부. 
