...
--유저 기본정보 입니다. 
--가입순서, 기능번호, 이름,닉네임, 아이디 , 비밀번호 ,성별, 나이, 핸드폰번호, 이메일, 가입일자, 유저 조회수(필요없음), 유저 추천수(FAVORITEMUSICIAN TABLE에서 산출 가능), 활성화여부
CREATE TABLE USERINFO(
	...
	USERINFO_ID VARCHAR2(30) NOT NULL,
...
SELECT USERINFO_SEQ, USERINFO_CONTROLNO, USERINFO_NAME, USERINFO_NICKNAME, USERINFO_SEX, USERINFO_AGE, USERINFO_PHONNUMBER, USERINFO_EMAIL, USERINFO_SIGNDATE, USERINFO_ENABLE FROM USERINFO;

INSERT INTO USERINFO 
	VALUES(USERINFOSEQ.NEXTVAL,'0','조영찬','메롱캬르르','M','27','010-3495-0424','zongyeng1@navre.com',SYSDATE,'Y');

INSERT INTO USERINFO (USERINFO_SEQ, USERINFO_CONTROLNO, USERINFO_NAME, USERINFO_NICKNAME, USERINFO_SEX, USERINFO_AGE, USERINFO_PHONNUMBER, USERINFO_EMAIL) 
	VALUES(USERINFOSEQ.NEXTVAL,'1','박훈성','pigstar0000','M','29','010-1234-5678','pigstar0000@navre.com');

INSERT INTO USERINFO (USERINFO_SEQ, USERINFO_CONTROLNO, USERINFO_NAME, USERINFO_NICKNAME, USERINFO_SEX, USERINFO_AGE, USERINFO_PHONNUMBER, USERINFO_EMAIL) 
	VALUES(USERINFOSEQ.NEXTVAL,'2','지광현','ghang0000','M','26','010-1234-5910','ghang0000@navre.com');
	
DROP SEQUENCE MUSICALBUMSEQ;
DROP TABLE MUSICALBUM;

CREATE SEQUENCE MUSICALBUMSEQ;
...
CREATE TABLE MUSICALBUM(
	MUSICALBUM_SEQ NUMBER PRIMARY KEY,
	MUSICALBUM_MUSICIANSEQ NUMBER,
	MUSICALBUM_ALBUMNO NUMBER,
	MUSICALBUM_ALBUMNAME VARCHAR2(30) NOT NULL,
	MUSICALBUM_ALBUMSIZE NUMBER NOT NULL,
	MUSICALBUM_ALBUMTIME NUMBER NOT NULL,
	MUSICALBUM_ALBUMCONTENT VARCHAR2(300) DEFAULT '없음' NOT NULL,
	MUSICALBUM_ALBUMINPUTDATE DATE DEFAULT SYSDATE NOT NULL,
	MUSICALBUM_ALBUMTAG VARCHAR2(300) DEFAULT '미지정' NOT NULL,
	MUSICALBUM_ALBUMENABLE CHAR(1) DEFAULT 'Y' CONSTRAINT ENABLEALBUMCHECK CHECK (MUSICALBUM_ALBUMENABLE IN ('Y','N')),
	CONSTRAINT MUSICALBUMFK FOREIGN KEY(MUSICALBUM_MUSICIANSEQ) REFERENCES USERINFO(USERINFO_SEQ)
);

SELECT MUSICALBUM_SEQ, MUSICALBUM_MUSICIANSEQ, MUSICALBUM_ALBUMNO, MUSICALBUM_ALBUMNAME, MUSICALBUM_ALBUMSIZE, MUSICALBUM_ALBUMTIME, MUSICALBUM_ALBUMCONTENT, MUSICALBUM_ALBUMINPUTDATE, MUSICALBUM_ALBUMTAG, MUSICALBUM_ALBUMENABLE
	FROM MUSICALBUM WHERE MUSICALBUM_MUSICIANSEQ = '1' ORDER BY MUSICALBUM_ALBUMNO ASC;

INSERT INTO MUSICALBUM VALUES(MUSICALBUMSEQ.NEXTVAL,'1','0','SINGLE','0','0','SINGLEMUSIC',SYSDATE,'미지정','N');
...
CREATE TABLE MUSICIANSONG(
	MUSICIANSONG_SEQ NUMBER PRIMARY KEY,
	MUSICIANSONG_MUSICIANSEQ NUMBER,
	MUSICIANSONG_NO NUMBER,
	MUSICIANSONG_TITLE VARCHAR2(100) NOT NULL,
	MUSICIANSONG_SIZE NUMBER NOT NULL,
	MUSICIANSONG_TIME NUMBER NOT NULL,
	MUSICIANSONG_HIGHLIGHTTIME NUMBER DEFAULT '0' NOT NULL,
	MUSICIANSONG_CONTENT VARCHAR2(300) DEFAULT '없음' NOT NULL,
	MUSICIANSONG_COMPOSER VARCHAR2(100) DEFAULT '미상'  NOT NULL,
	MUSICIANSONG_LYRICIST VARCHAR2(100) DEFAULT '미상' NOT NULL,
	MUSICIANSONG_INPUTDATE DATE DEFAULT SYSDATE NOT NULL,
	MUSICIANSONG_TAG VARCHAR2(300) DEFAULT '미지정',
	MUSICIANSONG_ENABLE CHAR(1) DEFAULT 'Y' CONSTRAINT ENABLESONGCHECK CHECK (MUSICIANSONG_ENABLE IN ('Y','N')),
	MUSICIANSONG_ALBUM NUMBER DEFAULT '1',
	CONSTRAINT MUSICIANFK FOREIGN KEY(MUSICIANSONG_MUSICIANSEQ) REFERENCES USERINFO(USERINFO_SEQ),
	CONSTRAINT MUSICIANALBUMFK FOREIGN KEY(MUSICIANSONG_ALBUM) REFERENCES MUSICALBUM(MUSICALBUM_SEQ)
);

SELECT MUSICIANSONG_SEQ, MUSICIANSONG_MUSICIANSEQ, MUSICIANSONG_NO, MUSICIANSONG_TITLE, MUSICIANSONG_SIZE, MUSICIANSONG_TIME, MUSICIANSONG_HIGHLIGHTTIME, MUSICIANSONG_CONTENT, MUSICIANSONG_COMPOSER, MUSICIANSONG_LYRICIST, MUSICIANSONG_INPUTDATE, MUSICIANSONG_TAG, MUSICIANSONG_ENABLE, MUSICIANSONG_ALBUM 
	FROM MUSICIANSONG WHERE MUSICIANSONG_MUSICIANSEQ='2' ORDER BY MUSICIANSONG_NO;

INSERT INTO MUSICIANSONG 
	VALUES(SONGSEQ.NEXTVAL,'2','1','2_FUNKEYMUSIC','13','0350','0123','펑키뮤직!','박훈성','조영찬',SYSDATE,'funky','Y','1');

INSERT INTO MUSICIANSONG (MUSICIANSONG_SEQ, MUSICIANSONG_MUSICIANSEQ, MUSICIANSONG_NO, MUSICIANSONG_TITLE, MUSICIANSONG_SIZE, MUSICIANSONG_TIME) 
	VALUES(SONGSEQ.NEXTVAL,'2','2','2_SMILEDAY','12.23','0401');
...
CREATE TABLE SONGSTATISTICS(
	...
	CONSTRAINT SONGSEQFK FOREIGN KEY(SONGSTATISTICS_SONGSEQ) REFERENCES MUSICIANSONG(MUSICIANSONG_SEQ) ON DELETE CASCADE
);
...
CREATE TABLE FAVORITEMUSIC(
	...
	FAVORITEMUSIC_MUSICIANSEQ NUMBER NOT NULL,
	CONSTRAINT FAVORITEMUSICFK FOREIGN KEY(FAVORITEMUSIC_MUSICIANSEQ) REFERENCES MUSICIANSONG(MUSICIANSONG_SEQ)
);
...
CREATE TABLE MYMUSICLIST(
	...
	MYMUSICLIST_MUSICIANSEQ NUMBER NOT NULL,
	CONSTRAINT MYMUSICLIST FOREIGN KEY(MYMUSICLIST_MUSICIANSEQ) REFERENCES MUSICIANSONG(MUSICIANSONG_SEQ)
);
