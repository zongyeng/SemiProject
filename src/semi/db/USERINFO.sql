...
CREATE TABLE FAVORITEMUSIC(
	...
	CONSTRAINT FAVORITEMUSICFK FOREIGN KEY(FAVORITEMUSIC_MUSICIANSONGSEQ) REFERENCES MUSICIANSONG(MUSICIANSONG_SEQ)
);
...
CREATE TABLE MYMUSICLIST(
	...
	CONSTRAINT MYMUSICLIST FOREIGN KEY(MYMUSICLIST_MUSICIANSONGSEQ) REFERENCES MUSICIANSONG(MUSICIANSONG_SEQ)
);
