...
INSERT INTO ALBUM VALUES(ALBUMSEQ.NEXTVAL,'1','0','SINGLE','0','0','SINGLEMUSIC',SYSDATE,'미지정','N');


DROP TABLE MUSIC;
DROP SEQUENCE MUSICSEQ;
ALTER TABLE MUSIC DROP CONSTRAINT MUSIC_FK;
ALTER TABLE MUSIC DROP CONSTRAINT MUSIC_ALBUM_FK;
...
>>>>>>> branch 'master' of https://github.com/zongyeng/SemiProject.git
);
